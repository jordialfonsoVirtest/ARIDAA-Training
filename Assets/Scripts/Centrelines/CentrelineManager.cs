...
public class CentrelineManager : MonoBehaviour
{
    ...
    [SerializeField] List<Vector3> activeCentrelinePoints;
    ...
    public void GetActiveCentrelinePoints()
    {
        foreach (Point point in activeCentreline.GetComponent<CentrelineRenderer>().GetCentrelinePoints())
        {
            activeCentrelinePoints.Add(new Vector3((float)point.coordx, (float)point.coordy,(float)point.coordz));
        }
    }
