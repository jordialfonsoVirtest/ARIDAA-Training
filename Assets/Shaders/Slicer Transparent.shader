Shader "Custom/ClippingPlaneTransparent"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        CGPROGRAM
        #pragma surface surf Standard fullforwardshadows alpha:fade // alpha:fade enables alpha blending in surface shader
        #pragma target 3.0
        

        // Define the shader feature to switch between opaque and transparent rendering setup
        #pragma shader_feature_local _CUTTRANSPARENCY_ON
